...
do
        ...
        do
                nohup python -u main.py  --seed $seed --num_variables 5  --num_subjects_per_group $n_sub --num_samples 60 --num_groups 2 > nohup.txt 2>&1 &
                sleep 3
        done
        # wait
done
...
do
        ...
        do
                nohup python -u main.py  --seed $seed  --num_variables 5 --num_subjects_per_group $((60 / $n_group)) --num_samples 60 --num_groups $n_group  > nohup.txt 2>&1 &
                sleep 3
        done
        # wait
done
