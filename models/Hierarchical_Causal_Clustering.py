...
class Hierarchical_Causal_Clustering(object):
    ...
    def init_prior(self):
        ...
        # Referred from:https://pytorch.org/docs/stable/distributions.html#mixturesamefamily and https://www.cnblogs.com/szcf715/p/8127416.html
        q_prime = m
